...
2D grid. Our valiant knight (K) was initially positioned in the top-left room and must fight his way through the dungeon to rescue the princess.
...
int main()
{
	...
	Solution sol;
	int t = sol.calculateMinimumHP(a);
	cout << t << endl;
	return 0;
}